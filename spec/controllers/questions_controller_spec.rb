...
RSpec.describe QuestionsController, type: :controller do
  ...
  let(:my_q) { Question.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph) }
  ...
  describe "PUT update" do 
    it "updates the question with extracted attributes" do 
    ...
    it "redirects to the upated question" do 
      new_title = RandomData.random_sentence
      new_body = RandomData.random_paragraph
      new_resolved = true
